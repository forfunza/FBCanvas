	...
	private void Injection(){
		string injection =
			"var headerElement = document.createElement('div');" +
				"headerElement.innerHTML = '<div class=ss>Check out our other great games: ...</div><br><div class=fb-like data-href=https://developers.facebook.com/docs/plugins/ data-layout=standard data-action=like data-show-faces=true data-share=true></div>';" +
