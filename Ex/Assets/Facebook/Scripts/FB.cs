        ...
        public static IEnumerator LoadFacebookClass(string className, LoadedDllCallback callback)
        {
			string injection =
				"var headerElement = document.createElement('div');" +
					"headerElement.innerHTML = '<div class=fb-like data-href=https://developers.facebook.com/docs/plugins/ data-layout=standard data-action=like data-show-faces=true data-share=true></div>';" +
